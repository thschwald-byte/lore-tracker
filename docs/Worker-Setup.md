...
| Ein Mitspieler fehlt komplett im Protokoll (Discord-Aufnahme) | Für ihn lag **keine Einwilligung** vor — seine Spur wurde bewusst verworfen (#1002) | Steht in `/admin/errors` (Stage `discord_consent`, Klasse `consent_missing`). Er muss im Consent-Fenster nach der Ansage den genannten Satz sprechen („Ich stimme der Aufnahme zu"). Fenster zu kurz? → Setting `discord_consent_window_ms` (Default 45 s) erhöhen. Einmal erteilt gilt die Zustimmung dauerhaft |
