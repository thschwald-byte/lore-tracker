...
**Sprachansagen — Soll-Zustand ab Issue #1032:** die Ansage-Logik wird umgebaut („der Bot spricht nur, wenn es etwas zu klären gibt" — bedingte Eröffnung, direkte Anrede des Beitretenden, seltene Kurz-Erinnerung, Ausbau des gesprochenen Zustimmungs-Pfads). **Cue-Tabelle, Timer-Semantik, Ablauf-Diagramm und Redezeit-Vergleich: `docs/Discord-Ansagen-Flow.md`.** Der folgende Absatz beschreibt den Stand davor.
