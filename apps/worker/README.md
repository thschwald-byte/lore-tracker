...
- **`Worker.Recording.*`** — Audio-Capture (Batch-Modus pro Spieler + Single-Source-Raummikro-Modus; Live-Transkription wurde mit #418 entfernt), Whisper-CLI-Wrapper, Pipeline-Stages 1-4 (Transkript → Resümee → Epos → Chronik) + optionale Faithfulness-Stage gegen den NLI-Sidecar.
