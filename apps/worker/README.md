...
- **`Worker.Recording.*`** — Audio-Capture (LiveTranscribe + Batch-Modus + Single-Source-Modus), Whisper-CLI-Wrapper, Pipeline-Stages 1-4 (Transkript → Resümee → Epos → Chronik) + optionale Faithfulness-Stage gegen den NLI-Sidecar.
