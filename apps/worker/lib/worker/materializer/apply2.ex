defmodule Worker.Materializer.Apply2 do
  ...
  # + SessionFactDateSet bleiben bewusst auf ihrer eigenen Spalte — jeweils
  # zweiter Leser außerhalb des Guards, siehe #816-PR. Die Chronik-Pendants
  # sind mit #1092 nach `Worker.Materializer.Chronik` gewandert.)
