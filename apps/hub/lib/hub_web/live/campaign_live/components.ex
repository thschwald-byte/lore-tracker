defmodule HubWeb.CampaignLive.Components do
  ...
  # Issue #987 (God-Module-Split, #544-Budget): recording_bar/1, mic_controls/1,
  # mic_button_state/3, rec_state/1, elapsed/1 leben jetzt in
  # `HubWeb.CampaignLive.MicComponents` (eigenständige, nur untereinander
  # verwendete Gruppe).
