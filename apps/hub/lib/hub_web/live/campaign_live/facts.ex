defmodule HubWeb.CampaignLive.Facts do
  ...
  **Serverseitiges Gate** (`:curate_facts`, Member-Recht) + Feld-Validierung vor
  ...
  # Issue #1204: die Fakten-Spalte blättert je Session (`FaktenFenster`), über
  # den `fact_*`-Dispatch, damit `campaign_live.ex` nicht wächst. (Die
  # Review-Liste lief hier ebenfalls, bis #1211 sie abgebaut hat.)
