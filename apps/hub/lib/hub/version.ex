defmodule Hub.Version do
  @moduledoc """
  Compile-time-resolved Hub-Version + Git-SHA + Dirty-Flag.

  `vsn` kommt aus `apps/hub/mix.exs`, `sha` aus `git rev-parse --short HEAD`,
  ...
  bis recompile alt, bei Releases (gigalixir-Buildpack hat git verfügbar)
  ist der SHA der tatsächlich deployte Stand.
  """
