    ...
    [
      ...
      %{
        ...
        core: [
          ...
          {"Dr. Watson",
           "Mein lieber Holmes, das geht zu weit. Vor ein paar Jahrhunderten hätte man Sie verbrannt. Es stimmt, dass ich am Donnerstag einen Spaziergang über Land gemacht habe und gründlich durchnässt heimkam; aber ich habe die Kleider gewechselt — wie können Sie es ableiten?"},
          {"Sherlock Holmes",
      ...
      %{
        ...
        core: [
          ...
          {"SL",
           "Der König nickt: ‚Eben die. Nun denn — ich ließ mich törichterweise zu einigen Briefen hinreißen, kompromittierenden Briefen, die ich gern zurückkaufen würde. Doch die könnte ich abstreiten; eine Schrift lässt sich als Fälschung bezeichnen. Nein — das wahre Übel ist eine Fotografie.'"},
          {"Sherlock Holmes", "Erworben?"},
